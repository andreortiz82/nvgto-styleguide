...
export const componentsNav: NavItem = {
  ...
  children: [
    ...
    },
    {
      ...
      description: "Booking controls and shopping selectors — dates, guests, size, color.",
      children: [
        ...
        { label: "Size selector", href: "/components/molecules/size-selector/" },
        { label: "Color swatch", href: "/components/molecules/color-swatch/" },
        { label: "Quantity stepper", href: "/components/molecules/quantity-stepper/" },
        { label: "Product price", href: "/components/molecules/product-price/" },
        { label: "Wishlist button", href: "/components/molecules/wishlist-button/" },
        { label: "Product badge", href: "/components/molecules/product-badge/" },
      ],
    },
    {
      label: "Organisms",
      href: "/components/organisms/",
      description: "Full UI sections — search, listing cards, product cards, bag.",
      children: [
        ...
        { label: "Product card", href: "/components/organisms/product-card/" },
        { label: "Product gallery", href: "/components/organisms/product-gallery/" },
        { label: "Cart line", href: "/components/organisms/cart-line/" },
        { label: "Cart drawer", href: "/components/organisms/cart-drawer/" },
        { label: "Lookbook row", href: "/components/organisms/lookbook-row/" },
        { label: "Product grid", href: "/components/organisms/product-grid/" },
      ],
    },
    {
      label: "Pages",
...
export const siteNav: NavItem[] = [
  ...
  { label: "Getting started", href: "/getting-started/" },
  {
    ...
    children: [
      ...
      { label: "Icons", href: "/tokens/icons/" },
      { label: "Charts", href: "/tokens/charts/" },
    ],
  },
  componentsNav,
];
