...
Navigato is a small MIT travel-booking library. `@navigato/react` is the system. Unconstrained generation is vibe coding.
...
- Restyle via tokens (`primary`, `muted`, `destructive`). Do not fork Button or Dialog because the brand is orange.
